...
public class BTApplicationLike extends DefaultApplicationLike {

    public BTApplicationLike(Application application, int tinkerFlags, boolean tinkerLoadVerifyFlag,
